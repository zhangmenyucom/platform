...
public class ApiArticleController {
    ...
    public R list(@PathVariable("merchantId") Long merchantId, @RequestParam Map<String, Object> params) {
        ...
        List<ArticleEntity> articleList = apiArticleService.queryList(query);
    ...
    public R info(@PathVariable("id") Long id) {
        ArticleEntity article = apiArticleService.queryObject(id);
    ...
    public R queryAll(@PathVariable("merchantId") Long merchantId, @RequestParam Map<String, Object> params) {
        List<ArticleEntity> list = apiArticleService.queryList(params, merchantId);
