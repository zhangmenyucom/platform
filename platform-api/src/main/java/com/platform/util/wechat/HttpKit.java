...
public class HttpKit {
    ...
    static {
        ...
        //证书密码
        char[] keyStorePassword = MCH_ID.toCharArray();
        try {
    ...
    public static String get(String url, Map<String, String> params, Map<String, String> headers) {
        AsyncHttpClient http = new AsyncHttpClient(new AsyncHttpClientConfig.Builder().setConnectTimeout(CONNECT_TIME_OUT).build());
    ...
    public static String posts(String url, Map<String, String> params) {
        ...
        AsyncHttpClient http = new AsyncHttpClient(new AsyncHttpClientConfig.Builder().setConnectTimeout(CONNECT_TIME_OUT).setSSLContext(wx_ssl_context).build());
