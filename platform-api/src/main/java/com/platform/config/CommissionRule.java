...
import com.platform.entity.UserLeveEnum;
...
import static com.platform.entity.UserLeveEnum.LEVEL_MAP;
...
public class CommissionRule {
    ...
    public static CommissionOrderVo getCommition(UserVo userVo, OrderVo orderVo, Integer grade) {
    ...
    public void processGainBanlance(CommissionOrderVo commissionOrderVo, Integer grade) {
        ...
        UserLeveEnum userSouceLeveEnum = LEVEL_MAP.get(userSource.getUser_level_id());
        UserLeveEnum userSelfLeveEnum = LEVEL_MAP.get(userSelf.getUser_level_id());
        switch (userSouceLeveEnum) {
            case NORMAL:
                commissionOrderVo.setGainBalance(BigDecimal.ZERO);
                commissionOrderVo.setDetail("普通会员无佣金");
                break;
            case VIP:
                switch (userSelfLeveEnum) {
                    case NORMAL:
                        commissionOrderVo.setGainBalance(BigDecimal.ZERO);
                        commissionOrderVo.setDetail("会员发展普通会员无佣金");
                        break;
                    case VIP:
                        if (grade == 1) {
                    ...
                    case CHUANGKE:
                        ...
                        if (grade == 2) {
                            ...
                            commissionOrderVo.setDetail("会员下级发展创客佣金4000元");
                        }
                        break;
                    case HEHUOREN:
                        if (grade == 1) {
                        ...
                        if (grade == 2) {
                            commissionOrderVo.setGainBalance(BigDecimal.valueOf(6000));
                            commissionOrderVo.setDetail("会员下级发展合伙人奖励佣金6000元");
                        }
                    default:
                }
            case CHUANGKE:
                switch (userSelfLeveEnum) {
                    case NORMAL:
                        commissionOrderVo.setGainBalance(BigDecimal.ZERO);
                        commissionOrderVo.setDetail("创客发展普通会员无佣金");
                        break;
                    case VIP:
                        if (grade == 1) {
                            commissionOrderVo.setGainBalance(BigDecimal.valueOf(5.4));
                        ...
                        if (grade == 2) {
                            commissionOrderVo.setGainBalance(BigDecimal.valueOf(3.6));
                            commissionOrderVo.setDetail("创客下级发展会员奖励佣金3.6元");
                        }
                        break;
                    case CHUANGKE:
                        if (grade == 1) {
                    ...
                    case HEHUOREN:
                        ...
                        if (grade == 2) {
                            commissionOrderVo.setGainBalance(BigDecimal.valueOf(6000));
                            commissionOrderVo.setDetail("创客下级发展合伙人奖励佣金6000元");
                        }
                    default:
                }
            case HEHUOREN:
                switch (userSelfLeveEnum) {
                    case NORMAL:
                        commissionOrderVo.setGainBalance(BigDecimal.ZERO);
                        commissionOrderVo.setDetail("合伙人发展普通会员无佣金");
                        break;
                    case VIP:
                        if (grade == 1) {
                            commissionOrderVo.setGainBalance(BigDecimal.valueOf(5.4));
                    ...
                    case HEHUOREN:
                        ...
                        if (grade == 2) {
                            commissionOrderVo.setGainBalance(BigDecimal.valueOf(4000));
                            commissionOrderVo.setDetail("合伙人下级发展合伙人奖励佣金4000元");
                        }
                    default:
                }
            default:
